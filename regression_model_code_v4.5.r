...
data <- read.csv("d:\\760.project\\main\\main_lr2.csv")
...
write.csv(F_info,"d:\\760.project\\F_info_lr.csv",row.names=FALSE)
...
"client_bureau_balance_csv_STATUS_3_count_norm_sum",
"client_bureau_balance_csv_STATUS_5_count_max",
"client_bureau_balance_csv_STATUS_5_count_norm_sum",
...
"client_bureau_balance_csv_STATUS_X_count_mean",
...
"per_FLAG_LAST_APPL_PER_CONTRACT_N_count",
...
"per_CODE_REJECT_REASON_SCO_count",
...
"per_NAME_PORTFOLIO_Cash_count_norm",
...
"per_NAME_PRODUCT_TYPE_x.sell_count_norm",
...
"EXT_SOURCE_3_plus_EXT_SOURCE_2",
"EXT_SOURCE_3_multi_EXT_SOURCE_2",
"EXT_SOURCE_3_minus_flag_pay_late_mean",
"EXT_SOURCE_3_minus_main_CODE_GENDER_M_count",
"EXT_SOURCE_3_plus_DAYS_BIRTH",
"EXT_SOURCE_3_minus_DAYS_BIRTH",
"EXT_SOURCE_3_multi_DAYS_BIRTH",
"EXT_SOURCE_3_plus_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"EXT_SOURCE_3_multi_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"EXT_SOURCE_3_plus_per_DAYS_DECISION_min",
"EXT_SOURCE_3_minus_per_DAYS_DECISION_min",
"EXT_SOURCE_3_multi_per_DAYS_DECISION_min",
"EXT_SOURCE_3_minus_per_NAME_YIELD_GROUP_high_count_norm",
"EXT_SOURCE_3_plus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"EXT_SOURCE_3_multi_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"EXT_SOURCE_3_multi_per_HOUR_APPR_PROCESS_START_max",
"EXT_SOURCE_3_plus_DAYS_ID_PUBLISH",
"EXT_SOURCE_3_minus_DAYS_ID_PUBLISH",
"EXT_SOURCE_3_multi_DAYS_ID_PUBLISH",
"EXT_SOURCE_3_plus_main_OCCUPATION_TYPE_Core.staff_count",
"EXT_SOURCE_3_minus_main_OCCUPATION_TYPE_Core.staff_count",
"EXT_SOURCE_3_minus_REG_CITY_NOT_LIVE_CITY",
"EXT_SOURCE_3_plus_main_NAME_INCOME_TYPE_State.servant_count",
"EXT_SOURCE_3_minus_main_NAME_INCOME_TYPE_State.servant_count",
"EXT_SOURCE_3_plus_FLAG_DOCUMENT_16",
"EXT_SOURCE_3_minus_FLAG_DOCUMENT_16",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_EXT_SOURCE_2",
"main_NAME_EDUCATION_TYPE_Higher.education_count_minus_flag_pay_late_mean",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_main_CODE_GENDER_M_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_main_CODE_GENDER_M_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_DAYS_BIRTH",
"main_NAME_EDUCATION_TYPE_Higher.education_count_minus_DAYS_BIRTH",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_DAYS_BIRTH",
"main_NAME_EDUCATION_TYPE_Higher.education_count_division_DAYS_BIRTH",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_per_DAYS_DECISION_min",
"main_NAME_EDUCATION_TYPE_Higher.education_count_minus_per_DAYS_DECISION_min",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_per_DAYS_DECISION_min",
"main_NAME_EDUCATION_TYPE_Higher.education_count_minus_FLAG_DOCUMENT_3",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_FLAG_DOCUMENT_3",
"main_NAME_EDUCATION_TYPE_Higher.education_count_minus_per_NAME_YIELD_GROUP_high_count_norm",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_per_HOUR_APPR_PROCESS_START_max",
"main_NAME_EDUCATION_TYPE_Higher.education_count_minus_per_HOUR_APPR_PROCESS_START_max",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_main_WALLSMATERIAL_MODE_Panel_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_main_WALLSMATERIAL_MODE_Panel_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_minus_main_NAME_FAMILY_STATUS_Married_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_main_NAME_FAMILY_STATUS_Married_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_DAYS_ID_PUBLISH",
"main_NAME_EDUCATION_TYPE_Higher.education_count_minus_DAYS_ID_PUBLISH",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_DAYS_ID_PUBLISH",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_main_OCCUPATION_TYPE_Core.staff_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_main_OCCUPATION_TYPE_Core.staff_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_REG_CITY_NOT_LIVE_CITY",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_REG_CITY_NOT_LIVE_CITY",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_main_NAME_INCOME_TYPE_State.servant_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_main_NAME_INCOME_TYPE_State.servant_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_NAME_EDUCATION_TYPE_Higher.education_count_plus_FLAG_DOCUMENT_16",
"main_NAME_EDUCATION_TYPE_Higher.education_count_multi_FLAG_DOCUMENT_16",
"EXT_SOURCE_2_minus_flag_pay_late_mean",
"EXT_SOURCE_2_plus_DAYS_BIRTH",
"EXT_SOURCE_2_minus_DAYS_BIRTH",
"EXT_SOURCE_2_multi_DAYS_BIRTH",
"EXT_SOURCE_2_plus_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"EXT_SOURCE_2_multi_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"EXT_SOURCE_2_plus_per_DAYS_DECISION_min",
"EXT_SOURCE_2_minus_per_DAYS_DECISION_min",
"EXT_SOURCE_2_multi_per_DAYS_DECISION_min",
"EXT_SOURCE_2_minus_per_NAME_YIELD_GROUP_high_count_norm",
"EXT_SOURCE_2_plus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"EXT_SOURCE_2_multi_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"EXT_SOURCE_2_multi_per_HOUR_APPR_PROCESS_START_max",
"EXT_SOURCE_2_plus_DAYS_ID_PUBLISH",
"EXT_SOURCE_2_minus_DAYS_ID_PUBLISH",
"EXT_SOURCE_2_multi_DAYS_ID_PUBLISH",
"EXT_SOURCE_2_plus_main_OCCUPATION_TYPE_Core.staff_count",
"EXT_SOURCE_2_minus_main_OCCUPATION_TYPE_Core.staff_count",
"EXT_SOURCE_2_minus_REG_CITY_NOT_LIVE_CITY",
"EXT_SOURCE_2_plus_main_NAME_INCOME_TYPE_State.servant_count",
"EXT_SOURCE_2_minus_main_NAME_INCOME_TYPE_State.servant_count",
"EXT_SOURCE_2_plus_FLAG_DOCUMENT_16",
"EXT_SOURCE_2_minus_FLAG_DOCUMENT_16",
"EXT_SOURCE_2_multi_FLAG_DOCUMENT_16",
"flag_pay_late_mean_multi_main_CODE_GENDER_M_count",
"flag_pay_late_mean_plus_DAYS_BIRTH",
"flag_pay_late_mean_minus_DAYS_BIRTH",
"flag_pay_late_mean_multi_DAYS_BIRTH",
"flag_pay_late_mean_division_DAYS_BIRTH",
"flag_pay_late_mean_minus_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"flag_pay_late_mean_plus_per_DAYS_DECISION_min",
"flag_pay_late_mean_minus_per_DAYS_DECISION_min",
"flag_pay_late_mean_multi_per_DAYS_DECISION_min",
"flag_pay_late_mean_plus_FLAG_DOCUMENT_3",
"flag_pay_late_mean_multi_FLAG_DOCUMENT_3",
"flag_pay_late_mean_plus_per_NAME_YIELD_GROUP_high_count_norm",
"flag_pay_late_mean_minus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"flag_pay_late_mean_multi_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"flag_pay_late_mean_plus_per_HOUR_APPR_PROCESS_START_max",
"flag_pay_late_mean_minus_per_HOUR_APPR_PROCESS_START_max",
"flag_pay_late_mean_multi_per_HOUR_APPR_PROCESS_START_max",
"flag_pay_late_mean_minus_main_WALLSMATERIAL_MODE_Panel_count",
"flag_pay_late_mean_plus_DAYS_ID_PUBLISH",
"flag_pay_late_mean_minus_DAYS_ID_PUBLISH",
"flag_pay_late_mean_multi_DAYS_ID_PUBLISH",
"flag_pay_late_mean_minus_main_OCCUPATION_TYPE_Core.staff_count",
"flag_pay_late_mean_plus_REG_CITY_NOT_LIVE_CITY",
"flag_pay_late_mean_multi_REG_CITY_NOT_LIVE_CITY",
"flag_pay_late_mean_minus_main_NAME_INCOME_TYPE_State.servant_count",
"flag_pay_late_mean_minus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"flag_pay_late_mean_plus_FLAG_DOCUMENT_16",
"flag_pay_late_mean_minus_FLAG_DOCUMENT_16",
"main_CODE_GENDER_M_count_plus_DAYS_BIRTH",
"main_CODE_GENDER_M_count_minus_DAYS_BIRTH",
"main_CODE_GENDER_M_count_multi_DAYS_BIRTH",
"main_CODE_GENDER_M_count_division_DAYS_BIRTH",
"main_CODE_GENDER_M_count_plus_per_DAYS_DECISION_min",
"main_CODE_GENDER_M_count_minus_per_DAYS_DECISION_min",
"main_CODE_GENDER_M_count_multi_per_DAYS_DECISION_min",
"main_CODE_GENDER_M_count_minus_FLAG_DOCUMENT_3",
"main_CODE_GENDER_M_count_multi_FLAG_DOCUMENT_3",
"main_CODE_GENDER_M_count_plus_per_NAME_YIELD_GROUP_high_count_norm",
"main_CODE_GENDER_M_count_minus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"main_CODE_GENDER_M_count_minus_per_HOUR_APPR_PROCESS_START_max",
"main_CODE_GENDER_M_count_plus_main_WALLSMATERIAL_MODE_Panel_count",
"main_CODE_GENDER_M_count_multi_main_WALLSMATERIAL_MODE_Panel_count",
"main_CODE_GENDER_M_count_minus_main_NAME_FAMILY_STATUS_Married_count",
"main_CODE_GENDER_M_count_multi_main_NAME_FAMILY_STATUS_Married_count",
"main_CODE_GENDER_M_count_plus_DAYS_ID_PUBLISH",
"main_CODE_GENDER_M_count_minus_DAYS_ID_PUBLISH",
"main_CODE_GENDER_M_count_multi_DAYS_ID_PUBLISH",
"main_CODE_GENDER_M_count_plus_main_OCCUPATION_TYPE_Core.staff_count",
"main_CODE_GENDER_M_count_multi_main_OCCUPATION_TYPE_Core.staff_count",
"main_CODE_GENDER_M_count_plus_REG_CITY_NOT_LIVE_CITY",
"main_CODE_GENDER_M_count_multi_REG_CITY_NOT_LIVE_CITY",
"main_CODE_GENDER_M_count_plus_main_NAME_INCOME_TYPE_State.servant_count",
"main_CODE_GENDER_M_count_multi_main_NAME_INCOME_TYPE_State.servant_count",
"main_CODE_GENDER_M_count_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_CODE_GENDER_M_count_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_CODE_GENDER_M_count_plus_FLAG_DOCUMENT_16",
"main_CODE_GENDER_M_count_multi_FLAG_DOCUMENT_16",
"DAYS_BIRTH_plus_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"DAYS_BIRTH_minus_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"DAYS_BIRTH_multi_per_NAME_CONTRACT_STATUS_Approved_count_norm",
"DAYS_BIRTH_plus_per_DAYS_DECISION_min",
"DAYS_BIRTH_minus_per_DAYS_DECISION_min",
"DAYS_BIRTH_multi_per_DAYS_DECISION_min",
"DAYS_BIRTH_plus_FLAG_DOCUMENT_3",
"DAYS_BIRTH_minus_FLAG_DOCUMENT_3",
"DAYS_BIRTH_plus_per_NAME_YIELD_GROUP_high_count_norm",
"DAYS_BIRTH_minus_per_NAME_YIELD_GROUP_high_count_norm",
"DAYS_BIRTH_multi_per_NAME_YIELD_GROUP_high_count_norm",
"DAYS_BIRTH_plus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"DAYS_BIRTH_minus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"DAYS_BIRTH_multi_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"DAYS_BIRTH_plus_per_HOUR_APPR_PROCESS_START_max",
"DAYS_BIRTH_minus_per_HOUR_APPR_PROCESS_START_max",
"DAYS_BIRTH_multi_per_HOUR_APPR_PROCESS_START_max",
"DAYS_BIRTH_plus_main_WALLSMATERIAL_MODE_Panel_count",
"DAYS_BIRTH_minus_main_WALLSMATERIAL_MODE_Panel_count",
"DAYS_BIRTH_multi_main_WALLSMATERIAL_MODE_Panel_count",
"DAYS_BIRTH_plus_main_NAME_FAMILY_STATUS_Married_count",
"DAYS_BIRTH_minus_main_NAME_FAMILY_STATUS_Married_count",
"DAYS_BIRTH_plus_DAYS_ID_PUBLISH",
"DAYS_BIRTH_minus_DAYS_ID_PUBLISH",
"DAYS_BIRTH_multi_DAYS_ID_PUBLISH",
"DAYS_BIRTH_plus_main_OCCUPATION_TYPE_Core.staff_count",
"DAYS_BIRTH_minus_main_OCCUPATION_TYPE_Core.staff_count",
"DAYS_BIRTH_plus_REG_CITY_NOT_LIVE_CITY",
"DAYS_BIRTH_minus_REG_CITY_NOT_LIVE_CITY",
"DAYS_BIRTH_plus_main_NAME_INCOME_TYPE_State.servant_count",
"DAYS_BIRTH_minus_main_NAME_INCOME_TYPE_State.servant_count",
"DAYS_BIRTH_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"DAYS_BIRTH_minus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"DAYS_BIRTH_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"DAYS_BIRTH_plus_FLAG_DOCUMENT_16",
"DAYS_BIRTH_minus_FLAG_DOCUMENT_16",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_plus_per_DAYS_DECISION_min",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_minus_per_DAYS_DECISION_min",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_multi_per_DAYS_DECISION_min",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_minus_per_NAME_YIELD_GROUP_high_count_norm",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_plus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_multi_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_plus_per_HOUR_APPR_PROCESS_START_max",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_minus_per_HOUR_APPR_PROCESS_START_max",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_multi_per_HOUR_APPR_PROCESS_START_max",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_plus_main_WALLSMATERIAL_MODE_Panel_count",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_multi_main_WALLSMATERIAL_MODE_Panel_count",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_plus_main_NAME_FAMILY_STATUS_Married_count",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_plus_DAYS_ID_PUBLISH",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_minus_DAYS_ID_PUBLISH",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_multi_DAYS_ID_PUBLISH",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_minus_main_OCCUPATION_TYPE_Core.staff_count",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_minus_REG_CITY_NOT_LIVE_CITY",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_plus_main_NAME_INCOME_TYPE_State.servant_count",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_minus_main_NAME_INCOME_TYPE_State.servant_count",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_multi_main_NAME_INCOME_TYPE_State.servant_count",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_plus_FLAG_DOCUMENT_16",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_minus_FLAG_DOCUMENT_16",
"per_NAME_CONTRACT_STATUS_Approved_count_norm_multi_FLAG_DOCUMENT_16",
"per_DAYS_DECISION_min_plus_FLAG_DOCUMENT_3",
"per_DAYS_DECISION_min_minus_FLAG_DOCUMENT_3",
"per_DAYS_DECISION_min_plus_per_NAME_YIELD_GROUP_high_count_norm",
"per_DAYS_DECISION_min_minus_per_NAME_YIELD_GROUP_high_count_norm",
"per_DAYS_DECISION_min_plus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"per_DAYS_DECISION_min_minus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"per_DAYS_DECISION_min_multi_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"per_DAYS_DECISION_min_plus_per_HOUR_APPR_PROCESS_START_max",
"per_DAYS_DECISION_min_minus_per_HOUR_APPR_PROCESS_START_max",
"per_DAYS_DECISION_min_multi_per_HOUR_APPR_PROCESS_START_max",
"per_DAYS_DECISION_min_plus_main_WALLSMATERIAL_MODE_Panel_count",
"per_DAYS_DECISION_min_minus_main_WALLSMATERIAL_MODE_Panel_count",
"per_DAYS_DECISION_min_multi_main_WALLSMATERIAL_MODE_Panel_count",
"per_DAYS_DECISION_min_plus_main_NAME_FAMILY_STATUS_Married_count",
"per_DAYS_DECISION_min_minus_main_NAME_FAMILY_STATUS_Married_count",
"per_DAYS_DECISION_min_multi_main_NAME_FAMILY_STATUS_Married_count",
"per_DAYS_DECISION_min_plus_DAYS_ID_PUBLISH",
"per_DAYS_DECISION_min_multi_DAYS_ID_PUBLISH",
"per_DAYS_DECISION_min_plus_main_OCCUPATION_TYPE_Core.staff_count",
"per_DAYS_DECISION_min_minus_main_OCCUPATION_TYPE_Core.staff_count",
"per_DAYS_DECISION_min_plus_REG_CITY_NOT_LIVE_CITY",
"per_DAYS_DECISION_min_minus_REG_CITY_NOT_LIVE_CITY",
"per_DAYS_DECISION_min_plus_main_NAME_INCOME_TYPE_State.servant_count",
"per_DAYS_DECISION_min_minus_main_NAME_INCOME_TYPE_State.servant_count",
"per_DAYS_DECISION_min_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"per_DAYS_DECISION_min_minus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"per_DAYS_DECISION_min_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"per_DAYS_DECISION_min_plus_FLAG_DOCUMENT_16",
"per_DAYS_DECISION_min_minus_FLAG_DOCUMENT_16",
"FLAG_DOCUMENT_3_plus_per_NAME_YIELD_GROUP_high_count_norm",
"FLAG_DOCUMENT_3_multi_per_NAME_YIELD_GROUP_high_count_norm",
"FLAG_DOCUMENT_3_minus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"FLAG_DOCUMENT_3_plus_per_HOUR_APPR_PROCESS_START_max",
"FLAG_DOCUMENT_3_minus_per_HOUR_APPR_PROCESS_START_max",
"FLAG_DOCUMENT_3_multi_main_WALLSMATERIAL_MODE_Panel_count",
"FLAG_DOCUMENT_3_multi_main_NAME_FAMILY_STATUS_Married_count",
"FLAG_DOCUMENT_3_plus_DAYS_ID_PUBLISH",
"FLAG_DOCUMENT_3_minus_DAYS_ID_PUBLISH",
"FLAG_DOCUMENT_3_multi_main_OCCUPATION_TYPE_Core.staff_count",
"FLAG_DOCUMENT_3_multi_REG_CITY_NOT_LIVE_CITY",
"FLAG_DOCUMENT_3_multi_main_NAME_INCOME_TYPE_State.servant_count",
"FLAG_DOCUMENT_3_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"FLAG_DOCUMENT_3_multi_FLAG_DOCUMENT_16",
"per_NAME_YIELD_GROUP_high_count_norm_minus_per_NAME_PRODUCT_TYPE_XNA_count_norm",
"per_NAME_YIELD_GROUP_high_count_norm_plus_per_HOUR_APPR_PROCESS_START_max",
"per_NAME_YIELD_GROUP_high_count_norm_minus_per_HOUR_APPR_PROCESS_START_max",
"per_NAME_YIELD_GROUP_high_count_norm_multi_per_HOUR_APPR_PROCESS_START_max",
"per_NAME_YIELD_GROUP_high_count_norm_minus_main_WALLSMATERIAL_MODE_Panel_count",
"per_NAME_YIELD_GROUP_high_count_norm_minus_main_NAME_FAMILY_STATUS_Married_count",
"per_NAME_YIELD_GROUP_high_count_norm_plus_DAYS_ID_PUBLISH",
"per_NAME_YIELD_GROUP_high_count_norm_minus_DAYS_ID_PUBLISH",
"per_NAME_YIELD_GROUP_high_count_norm_multi_DAYS_ID_PUBLISH",
"per_NAME_YIELD_GROUP_high_count_norm_minus_main_OCCUPATION_TYPE_Core.staff_count",
"per_NAME_YIELD_GROUP_high_count_norm_plus_REG_CITY_NOT_LIVE_CITY",
"per_NAME_YIELD_GROUP_high_count_norm_minus_main_NAME_INCOME_TYPE_State.servant_count",
"per_NAME_YIELD_GROUP_high_count_norm_minus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"per_NAME_YIELD_GROUP_high_count_norm_plus_FLAG_DOCUMENT_16",
"per_NAME_YIELD_GROUP_high_count_norm_minus_FLAG_DOCUMENT_16",
"per_NAME_YIELD_GROUP_high_count_norm_multi_FLAG_DOCUMENT_16",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_plus_per_HOUR_APPR_PROCESS_START_max",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_minus_per_HOUR_APPR_PROCESS_START_max",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_multi_per_HOUR_APPR_PROCESS_START_max",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_plus_main_WALLSMATERIAL_MODE_Panel_count",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_multi_main_WALLSMATERIAL_MODE_Panel_count",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_plus_main_NAME_FAMILY_STATUS_Married_count",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_multi_main_NAME_FAMILY_STATUS_Married_count",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_plus_DAYS_ID_PUBLISH",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_minus_DAYS_ID_PUBLISH",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_multi_DAYS_ID_PUBLISH",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_plus_main_OCCUPATION_TYPE_Core.staff_count",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_multi_main_OCCUPATION_TYPE_Core.staff_count",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_minus_REG_CITY_NOT_LIVE_CITY",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_plus_main_NAME_INCOME_TYPE_State.servant_count",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_multi_main_NAME_INCOME_TYPE_State.servant_count",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_plus_FLAG_DOCUMENT_16",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_minus_FLAG_DOCUMENT_16",
"per_NAME_PRODUCT_TYPE_XNA_count_norm_multi_FLAG_DOCUMENT_16",
"per_HOUR_APPR_PROCESS_START_max_plus_main_WALLSMATERIAL_MODE_Panel_count",
"per_HOUR_APPR_PROCESS_START_max_minus_main_WALLSMATERIAL_MODE_Panel_count",
"per_HOUR_APPR_PROCESS_START_max_multi_main_WALLSMATERIAL_MODE_Panel_count",
"per_HOUR_APPR_PROCESS_START_max_plus_main_NAME_FAMILY_STATUS_Married_count",
"per_HOUR_APPR_PROCESS_START_max_multi_main_NAME_FAMILY_STATUS_Married_count",
"per_HOUR_APPR_PROCESS_START_max_plus_DAYS_ID_PUBLISH",
"per_HOUR_APPR_PROCESS_START_max_minus_DAYS_ID_PUBLISH",
"per_HOUR_APPR_PROCESS_START_max_multi_DAYS_ID_PUBLISH",
"per_HOUR_APPR_PROCESS_START_max_plus_main_OCCUPATION_TYPE_Core.staff_count",
"per_HOUR_APPR_PROCESS_START_max_minus_main_OCCUPATION_TYPE_Core.staff_count",
"per_HOUR_APPR_PROCESS_START_max_multi_main_OCCUPATION_TYPE_Core.staff_count",
"per_HOUR_APPR_PROCESS_START_max_plus_REG_CITY_NOT_LIVE_CITY",
"per_HOUR_APPR_PROCESS_START_max_minus_REG_CITY_NOT_LIVE_CITY",
"per_HOUR_APPR_PROCESS_START_max_plus_main_NAME_INCOME_TYPE_State.servant_count",
"per_HOUR_APPR_PROCESS_START_max_minus_main_NAME_INCOME_TYPE_State.servant_count",
"per_HOUR_APPR_PROCESS_START_max_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"per_HOUR_APPR_PROCESS_START_max_minus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"per_HOUR_APPR_PROCESS_START_max_plus_FLAG_DOCUMENT_16",
"per_HOUR_APPR_PROCESS_START_max_minus_FLAG_DOCUMENT_16",
"main_WALLSMATERIAL_MODE_Panel_count_minus_main_NAME_FAMILY_STATUS_Married_count",
"main_WALLSMATERIAL_MODE_Panel_count_multi_main_NAME_FAMILY_STATUS_Married_count",
"main_WALLSMATERIAL_MODE_Panel_count_plus_DAYS_ID_PUBLISH",
"main_WALLSMATERIAL_MODE_Panel_count_minus_DAYS_ID_PUBLISH",
"main_WALLSMATERIAL_MODE_Panel_count_multi_DAYS_ID_PUBLISH",
"main_WALLSMATERIAL_MODE_Panel_count_plus_main_OCCUPATION_TYPE_Core.staff_count",
"main_WALLSMATERIAL_MODE_Panel_count_multi_main_OCCUPATION_TYPE_Core.staff_count",
"main_WALLSMATERIAL_MODE_Panel_count_plus_REG_CITY_NOT_LIVE_CITY",
"main_WALLSMATERIAL_MODE_Panel_count_multi_REG_CITY_NOT_LIVE_CITY",
"main_WALLSMATERIAL_MODE_Panel_count_plus_main_NAME_INCOME_TYPE_State.servant_count",
"main_WALLSMATERIAL_MODE_Panel_count_multi_main_NAME_INCOME_TYPE_State.servant_count",
"main_WALLSMATERIAL_MODE_Panel_count_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_WALLSMATERIAL_MODE_Panel_count_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_WALLSMATERIAL_MODE_Panel_count_plus_FLAG_DOCUMENT_16",
"main_WALLSMATERIAL_MODE_Panel_count_multi_FLAG_DOCUMENT_16",
"main_NAME_FAMILY_STATUS_Married_count_plus_DAYS_ID_PUBLISH",
"main_NAME_FAMILY_STATUS_Married_count_minus_DAYS_ID_PUBLISH",
"main_NAME_FAMILY_STATUS_Married_count_multi_DAYS_ID_PUBLISH",
"main_NAME_FAMILY_STATUS_Married_count_multi_main_OCCUPATION_TYPE_Core.staff_count",
"main_NAME_FAMILY_STATUS_Married_count_multi_REG_CITY_NOT_LIVE_CITY",
"main_NAME_FAMILY_STATUS_Married_count_plus_main_NAME_INCOME_TYPE_State.servant_count",
"main_NAME_FAMILY_STATUS_Married_count_multi_main_NAME_INCOME_TYPE_State.servant_count",
"main_NAME_FAMILY_STATUS_Married_count_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_NAME_FAMILY_STATUS_Married_count_plus_FLAG_DOCUMENT_16",
"main_NAME_FAMILY_STATUS_Married_count_multi_FLAG_DOCUMENT_16",
"DAYS_ID_PUBLISH_plus_main_OCCUPATION_TYPE_Core.staff_count",
"DAYS_ID_PUBLISH_minus_main_OCCUPATION_TYPE_Core.staff_count",
"DAYS_ID_PUBLISH_plus_REG_CITY_NOT_LIVE_CITY",
"DAYS_ID_PUBLISH_minus_REG_CITY_NOT_LIVE_CITY",
"DAYS_ID_PUBLISH_plus_main_NAME_INCOME_TYPE_State.servant_count",
"DAYS_ID_PUBLISH_minus_main_NAME_INCOME_TYPE_State.servant_count",
"DAYS_ID_PUBLISH_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"DAYS_ID_PUBLISH_minus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"DAYS_ID_PUBLISH_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"DAYS_ID_PUBLISH_plus_FLAG_DOCUMENT_16",
"DAYS_ID_PUBLISH_minus_FLAG_DOCUMENT_16",
"main_OCCUPATION_TYPE_Core.staff_count_plus_REG_CITY_NOT_LIVE_CITY",
"main_OCCUPATION_TYPE_Core.staff_count_multi_REG_CITY_NOT_LIVE_CITY",
"main_OCCUPATION_TYPE_Core.staff_count_plus_main_NAME_INCOME_TYPE_State.servant_count",
"main_OCCUPATION_TYPE_Core.staff_count_multi_main_NAME_INCOME_TYPE_State.servant_count",
"main_OCCUPATION_TYPE_Core.staff_count_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_OCCUPATION_TYPE_Core.staff_count_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_OCCUPATION_TYPE_Core.staff_count_plus_FLAG_DOCUMENT_16",
"main_OCCUPATION_TYPE_Core.staff_count_multi_FLAG_DOCUMENT_16",
"REG_CITY_NOT_LIVE_CITY_plus_main_NAME_INCOME_TYPE_State.servant_count",
"REG_CITY_NOT_LIVE_CITY_multi_main_NAME_INCOME_TYPE_State.servant_count",
"REG_CITY_NOT_LIVE_CITY_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"REG_CITY_NOT_LIVE_CITY_multi_main_NAME_INCOME_TYPE_Commercial.associate_count",
"REG_CITY_NOT_LIVE_CITY_plus_FLAG_DOCUMENT_16",
"REG_CITY_NOT_LIVE_CITY_multi_FLAG_DOCUMENT_16",
"main_NAME_INCOME_TYPE_State.servant_count_plus_main_NAME_INCOME_TYPE_Commercial.associate_count",
"main_NAME_INCOME_TYPE_State.servant_count_plus_FLAG_DOCUMENT_16",
"main_NAME_INCOME_TYPE_State.servant_count_multi_FLAG_DOCUMENT_16",
"main_NAME_INCOME_TYPE_Commercial.associate_count_plus_FLAG_DOCUMENT_16",
"main_NAME_INCOME_TYPE_Commercial.associate_count_multi_FLAG_DOCUMENT_16")

trn <- trn[var_list]
oot <- oot[var_list]
mrv <- mrv[var_list]

write.csv(trn,"d:\\760.project\\main_rf_trn.csv",row.names=FALSE)
write.csv(oot,"d:\\760.project\\main_rf_oot.csv",row.names=FALSE)
write.csv(mrv,"d:\\760.project\\main_rf_mrv.csv",row.names=FALSE)

trn <- read.csv("d:\\760.project\\main_rf_trn.csv")
oot <- read.csv("d:\\760.project\\main_rf_oot.csv")
mrv <- read.csv("d:\\760.project\\main_rf_mrv.csv")
...
list_f <- lr_stepwise(trn, oot, mrv, bad_flg="TARGET", F_info, nround=15, cv_num=3, weight_value=11, cl_num=8) 
...
pred1 <- prediction(mrv_p,mrv["TARGET"])
performance(pred1, "auc")
library(ModelMetrics)
for (i in 1:80)
	print(fScore(mrv[,1], mrv_p, cutoff = i/100, beta = 1))
...
write.csv(list_f,"d:\\760.project\\list_f_cor.csv",row.names=FALSE)

list_f <- read.csv("d:\\760.project\\list_f.csv")
w1 <- rep(1,length(trn[,1]));w1[trn[,1]==1] <- 11
list_fr <- rep(0,15)
for (i in 1:15)
	list_fr[i] <- which(names(data) == list_f$Feature_Name[i])
lr1 <- glm(TARGET~., data=trn[c(2,list_fr)], weights=w1, family=binomial())
...
for (i in 3:length(data))
  if (length(which(is.na(data[, i])))>0)
	data[which(is.na(data[, i])), i] <- round(mean(data[, i], na.rm=TRUE),1)